...
description: Launch an xcheck Remediator session - validate, census, plan and fix the next batch of accepted findings. Use when the user says /xcheck-remediate, "fix the findings", "remediate", optionally with a findings range (e.g. F-0012..F-0019) or a CF id.
---
