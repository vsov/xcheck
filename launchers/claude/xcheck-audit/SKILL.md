---
name: xcheck-audit
description: Launch an xcheck Auditor session - run the next queued audit pass and file evidence-backed findings. Use when the user says /xcheck-audit, "run a pass", "audit pass", optionally with a pass id (e.g. P-03).
---
