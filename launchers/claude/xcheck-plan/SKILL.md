---
name: xcheck-plan
description: Launch an xcheck Planner session - inventory the project and produce audit/AUDIT.md. Use when the user says /xcheck-plan, "plan the audit", "fill AUDIT.md", or wants to start an xcheck audit in a project that has audit/XCHECK.md installed.
---
